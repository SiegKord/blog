...
<html>
	...
	<body>
		...
		echo "Le titre de cet article est : <b>" . $article->getTitle() . "</b>, son auteur est <b>" . $article->getAuthor()->getPseudo() . "</b> publié le <b>" . $article->getDatepost() . "</b>. </br> Son contenu est : <b>" . $article->getContent() . "</b>";
		...
		foreach($articles as $eachArt) {
			...
			// if($eachArt->getAuthor() != null){
				// echo "Auteur : <b>" . $eachArt->getAuthor()->getPseudo() . "</b></br>";  //équivalent plus bas
			// }
			// else {
				// echo "Auteur : <b> Anonyme </b></br>";
			// }
			echo "Auteur : <b>" . ($eachArt->getAuthor()== null?"Anonyme":$eachArt->getAuthor()->getPseudo()) . "</b></br>";
